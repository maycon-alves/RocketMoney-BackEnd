...
public class Usuario extends Pessoa implements Serializable{
	...
	/**
	 * string de conhecimento do usuario utilizada para autenticacao no momento de login
	 */
	private String senha;
	/**
	 * string personalizavel pelo usuario utilizada para relacionamento com o usuario
	 */
	private String apelidoUsuario;
	/**
	 * sinaliza a experiencia do usuario com investimentos ENUM:[conservador; moderado; experiente;]
	 */
	private TipoPerfilInvestidorEnum tipoPerfilInvestidor;
	/**
	 * sinaliza a frequencia do faturamento do usuario ENUM:[fixoSemanal;fixoMensal;fixoAnual;variavel;misto;]
	 */
	...
	public Usuario(String cpf, String nome, String senha, String apelidoUsuario, TipoPerfilInvestidorEnum tipoPerfilInvestidor, TipoFaturamentoEnum tipoFaturamento) {
		super(cpf, nome);
		this.senha = senha;
