...
public class TesteMain {
	public static void main(String[] args) {
		...
		System.out.println("\n#########################################################################\n");
		GastoFixo gasto = new GastoFixo("021e52cd-a950-4505-a339-726c337ca12e", 2300.00, "Aluguel Apartamento",
				CategoriaGastoEnum.DESPESAFIXA, 5, PeriodoVencimentoEnum.MENSAL);
		System.out.println("Você cadastrou com sucesso o seu gasto com " + gasto.getDescricaoGasto() + " no valor de: "
				+ gasto.getValorGasto() + " " + gasto.getPeriodo());
