...
public class TesteMain {
	public static void main(String[] args) {
		...
		UsuarioModel user = new UsuarioModel(inCpf, inNome, inSenha, inApelido, perfil, faturamento);
		...
		if (g instanceof GastoFixoModel) {
			...
			((GastoMensalModel) g).setIdFormaPagamentoUtilizado("001");
			((GastoMensalModel) g).setDataCompra("10/03/2023");
			((GastoMensalModel) g).setQuantidadeParcela(opt);
